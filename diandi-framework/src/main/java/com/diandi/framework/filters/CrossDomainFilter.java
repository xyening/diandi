package com.diandi.framework.filters;
 ...
 * 支持跨域过滤器
 * 配置文件键值对如下
 * diandi.cross.alloworigin=* diandi.cross.allowheaders=Origin    diandi.cross.allowmethods=GET,POST,OPTIONS  diandi.cross.maxage=3628800
 */
