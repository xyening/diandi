package com.diandi.framework.configurations;
...
public abstract class PropertiesConfiguration {
    ...
    private final static String MS_CROSS_ALLOWORIGIN = "diandi.cross.alloworigin";
    private final static String MS_CROSS_ALLOWHEADERS = "diandi.cross.allowheaders";

    private final static String MS_CROSS_ALLOWMETHODS = "diandi.cross.allowmethods";
    private final static String MS_CROSS_MAXAGE = "diandi.cross.maxage";
